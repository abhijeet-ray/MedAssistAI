...
1. Extracts medical data from uploaded reports
2. Identifies key health metrics
3. Generates a visual health dashboard
4. Allows users to ask questions about their report
5. Provides role-specific explanations for doctors, patients, and community health workers
